...
// .wrangler/tmp/bundle-VipVEX/checked-fetch.js
...
var NavView = /* @__PURE__ */ __name((props) => {
  return /* @__PURE__ */ jsxDEV("div", { class: "glide bg-blue bg-opacity-90 backdrop-blur-sm p-1", children: [
    /* @__PURE__ */ jsxDEV("div", { class: "glide__track", "data-glide-el": "track", children: /* @__PURE__ */ jsxDEV("ul", { class: "glide__slides", children: props.areas.map((area) => {
      var image = "/images/" + area.image;
      var summary = "/areas/" + area.id + "/summary.html";
      console.log(summary);
      console.log(image);
      return /* @__PURE__ */ jsxDEV("li", { class: "glide__slide", "hx-get": summary, "hx-target": "#htmlSummaryContainer", children: /* @__PURE__ */ jsxDEV("div", { class: "image-container", children: [
        /* @__PURE__ */ jsxDEV("img", { src: image, alt: area.title }),
        /* @__PURE__ */ jsxDEV("div", { class: "image-label", children: area.title })
      ] }) });
    }) }) }),
    /* @__PURE__ */ jsxDEV("div", { class: "glide__arrows", "data-glide-el": "controls", children: [
      /* @__PURE__ */ jsxDEV("button", { class: "glide__arrow glide__arrow--left", "data-glide-dir": "<", children: "prev" }),
      /* @__PURE__ */ jsxDEV("button", { class: "glide__arrow glide__arrow--right", "data-glide-dir": ">", children: "next" })
    ] })
  ] });
}, "NavView");
...
var MapView = /* @__PURE__ */ __name((props) => {
  return /* @__PURE__ */ jsxDEV("html", { lang: "en", children: [
    /* @__PURE__ */ jsxDEV("head", { children: [
      ...
      /* @__PURE__ */ jsxDEV("script", { src: "https://cdnjs.cloudflare.com/ajax/libs/Glide.js/3.6.0/glide.min.js" }),
      /* @__PURE__ */ jsxDEV("link", { rel: "stylesheet", href: "https://cdnjs.cloudflare.com/ajax/libs/Glide.js/3.6.0/css/glide.core.min.css" }),
      /* @__PURE__ */ jsxDEV("link", { rel: "stylesheet", href: "https://cdnjs.cloudflare.com/ajax/libs/Glide.js/3.6.0/css/glide.theme.min.css" }),
...
// .wrangler/tmp/bundle-VipVEX/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-VipVEX/middleware-loader.entry.ts
